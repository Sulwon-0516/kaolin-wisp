...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    ops.def("hashgrid_interpolate_cuda_hyper", &hashgrid_interpolate_cuda_hyper);
    ops.def("hashgrid_interpolate_backward_cuda_hyper", &hashgrid_interpolate_backward_cuda_hyper);
}
