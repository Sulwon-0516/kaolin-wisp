...
class HyperTracer(BaseTracer):
    ...
    def trace(self, nef, channels, rays, lod_idx=None, raymarch_type='voxel', num_steps=64, step_size=1.0, bg_color='white', idx = torch.zeros(1, dtype=torch.int32), step = 0):
